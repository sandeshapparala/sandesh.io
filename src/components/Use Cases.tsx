        ...
        <section id="services" className="py-8 md:py-16">
            <div className="@container mx-auto max-w-5xl px-6">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-8 max-w-xl px-4 text-center text-base/6 text-gray-200">
                        I help businesses build modern, high-performance websites and integrate AI solutions that save time, improve efficiency, and drive growth.
                    </p>
                </div>
                <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 [--color-background:var(--color-muted)] [--color-card:var(--color-muted)] *:text-center md:mt-4 dark:[--color-muted:var(--color-zinc-900)]">
                    <Card className="group border-0 shadow-none bg-background">
                        ...
                        <CardContent className="flex flex-col h-full">
                            ...
                            <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                                <Link href="/projects" className="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                                    See Case Studies
                    ...
                    <Card className="group border-0 shadow-none bg-background">
                        ...
                        <CardContent className="flex flex-col h-full">
                            ...
                            <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                                <Link href="#booking" className="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                ...
                <div className="text-center mt-10">
                    <p className="text-base text-gray-600 dark:text-gray-300 mb-6">
                        Not sure which service fits your project? Let&apos;s figure it out together.
                    </p>
                    <Link
                        href="#booking"
                        className="inline-flex items-center gap-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 text-sm font-semibold transition-colors"
                    >
                        Book a Free Call
