...
export default function HeroSection() {
    return (
        ...
        <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pt-20 pb-10 md:px-8 md:pt-32 bg-black z-10">
            ...
            <div className="mb-10 mt-8 flex w-full flex-col items-center justify-center gap-4 px-8 sm:flex-row md:mb-13">
                <Button asChild className="group relative z-20 flex h-10 w-full cursor-pointer items-center justify-center space-x-2 rounded-lg bg-white p-px px-4 py-2 text-center text-sm font-semibold leading-6 text-black no-underline transition duration-200 hover:-translate-y-0.5 sm:w-52">
                    <Link href="#booking">Book a Free Strategy Call</Link>
                </Button>
                <Button
                    asChild
                    variant="outline"
            ...
            <div className="relative z-50 mb-8 flex items-center justify-center px-4 md:mb-6">
                <p className="text-center text-sm font-medium text-gray-400 tracking-wide">
                    Performance-first websites (Next.js, SEO-ready) &nbsp;&bull;&nbsp; AI integrations: chatbots, RAG, automations &nbsp;&bull;&nbsp; End-to-end build: design → dev → launch
                </p>
            </div>
